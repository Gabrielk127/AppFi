...
export default function Expense() {
  ...
  const [descExpense, setDescExpense] = useState<string>("");
  const [expenseValue, setExpenseValue] = useState<string>("R$0.00");
    ...
    <View style={styles.viewStyle}>
      ...
      >
        <View style={styles.containerTitle}>
          <ButtonBack />
          <Text style={styles.textTitle}>Despesa</Text>
        </View>

        <View style={styles.containerIncome}>
          <View style={styles.containerTextIncome}>
            <Text style={styles.textIncome}>Valor da despesa</Text>
            {isEditingValue ? (
              <TextInputMask
              ...
              <TouchableOpacity onPress={() => setIsEditingValue(true)}>
                <Text style={styles.textValueIncome}>{expenseValue}</Text>
              </TouchableOpacity>
            )}
          </View>
